      ...
      <div className="mt-12 grid gap-5 md:grid-cols-3">
        {steps.map((s) => {
          ...
          return (
            <div
              key={s.n}
              className="card-elevated card-elevated-hover group p-6 text-center"
            >
              <span className="grid h-12 w-12 place-items-center rounded-xl border border-[color:var(--primary)]/40 bg-[color:var(--primary)]/10 mx-auto">
