      ...
      <DialogContent className="flex flex-col overflow-hidden max-h-[90vh] p-0 sm:max-w-2xl">
        ...
        <div className="flex flex-col gap-4 overflow-y-auto p-6 max-h-[90vh]">
          ...
          <div className="mt-2 flex flex-col items-center gap-3 border-t border-white/10 pt-5 text-center">
            ...
            <Link
              to="/contact"
              className="btn-gradient min-h-9 text-center inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-semibold text-white transition-transform duration-200 hover:scale-[1.03]"
            >
              ...
              <div className="relative">
                ...
                <div data-share-exclude className="mt-5">
                  <ShareQuoteButton
                    ...
                    filename="anamdev-ai-integrator-quote"
